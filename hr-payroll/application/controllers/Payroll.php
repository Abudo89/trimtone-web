...
public function Invoice()
{
    if ($this->session->userdata('user_login_access') != False) {
        ...
        // if (isset($data['salaryvalue']) && isset($data['salaryvalue']->id)) {
        //     $data['addition'] = $this->payroll_model->getAdditionDataBySalaryID($data['salaryvalue']->id);
        //     $data['deduction'] = $this->payroll_model->getDeductionDataBySalaryID($data['salaryvalue']->id);
        // } else {
        //     $data['addition'] = [];
        //     $data['deduction'] = [];
        // }

        if (method_exists($this->payroll_model, 'getLoanInfoInvoice')) {
        ...
        if ($data['salary_info'] !== null && property_exists($data['salary_info'], 'year')) {
            ...
            if ($work_hour_diff < 0) {
                ...
                $deduction = abs($work_hour_diff) * $hourly_rate;
            }
            ...
            $data['a'] = $addition;
            $data['d'] = $data['salary_info']->deduction;
...
function load_employee_Invoice_by_EmId_for_pay()
{
    if ($this->session->userdata('user_login_access') != False) {
        ...
        echo "<div class='row payslip_print' id='payslip_print'>
            <div class='col-md-12'>
                <div class='card card-body'>
                    ...
                    <div class='row' style='margin-bottom: 5px;'>
                        <div class='col-md-12'>
                            <table class='table table-condensed borderless payslip_info'>
                                ...
                                <tr>
                                    <td>Days Worked</td>
                                    <td>:". ceil($salary_info->total_days / 8); echo"</td>";
                    ...
                    <div class='row'>
                        <div class='col-md-12'>
                            <table class='table table-bordered payslip_table'>
                                <thead>
                                    <tr>
                                        <th>Description</th>
                                        <th>Rate</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>:$employee_actually_worked[0]->Hours</td>
                                        <td>:$employee_actually_worked[0]->Hours</td>
                                    </tr>
                                    <tr>
                                        <td>Difference of Hour</td>
                                        <td>:</td>
                                        <td>:$work_hour_diff</td>
                                    </tr>";
                    ...
                    <div class='row'>
                        <div class='col-md-12'>
                            <p style='margin-top: 15px; margin-bottom: 15px;'>Salary Advice :</p>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='col-md-4'>
                            <h6 style='margin-bottom: 5px;'>Signatures :</h6>
                            <p>------------------------</p>
        ...
        .payslip_table tbody td {
            text-align: center;
        }

        .payslip_table tfoot td {
            text-align: center;
            font-weight: bold;
        }
        </style>";
   ...
   private function count_friday($month, $year) {
    ...
    if ($month >= 1 && $month <= 12) {
        ...
        // Handle the case of an invalid month value
        // You can add appropriate error handling or return a default value here.
